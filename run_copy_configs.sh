...
echo "  "
echo "===============Finished copying! Starting the coordinates generation for manual placement!==============="
echo "  "

python placement_cfg_gen.py

cd ..
cp -r ./$DIR/macro_placement.cfg ./designs/fpga_core